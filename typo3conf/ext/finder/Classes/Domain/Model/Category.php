 ...
 */
class Tx_Finder_Domain_Model_Category extends Tx_Extbase_DomainObject_AbstractEntity {
	/**
	 * @var integer
	 */
	protected $sorting;
	...
	/**
	 * @var Tx_Finder_Domain_Model_Category
	 * @lazy
	 */
	 ...
	 * @var integer
	 */
	protected $countRelatedFinder = 0;
	 ...
	 * Set parent category
	 *
	 * @param Tx_Finder_Domain_Model_Category $category parent category
	 * @return void
	 */
	public function setParentcategory(Tx_Finder_Domain_Model_Category $category) {
