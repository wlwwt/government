 ...
 */
class Tx_Finder_Domain_Model_Finder extends Tx_Extbase_DomainObject_AbstractEntity {
	...
	/**
	 * @var Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_Category>
	 * @lazy
	 */
	protected $categories;

	/**
	 * @var Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_Finder>
	 * @lazy
	 */
	protected $related;
	...
	/**
	 * @var Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_File>
	 * @lazy
	 */
	protected $relatedFiles;

	/**
	 * @var Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_Link>
	 * @lazy
	 */
	...
	/**
	 * @var Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_Media>
	 * @lazy
	 */
	protected $media;
	 ...
	 * @var boolean
	 */
	protected $istopfinder;

	/**
	 * @var Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_External_TtContent>
	 * @lazy
	 */
	protected $contentElements;

	/**
	 * @var Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_Tag>
	 * @lazy
	 */
	protected $tags;
	 ...
	 * Get categories
	 *
	 * @return Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_Category>
	 */
	 ...
	 * Get first category
	 *
	 * @return Tx_Finder_Domain_Model_Category
	 */
	 ...
	 *
	 * @param Tx_Finder_Domain_Model_Category $category
	 * @return void
	 */
	public function addCategory(Tx_Finder_Domain_Model_Category $category) {
	 ...
	 * Get related finder
	 *
	 * @return Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_Finder>
	 */
	 ...
	 * Set related from
	 *
	 * @param Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_Finder> $relatedFrom
	 * @return void
	 */
	 ...
	 * Set related finder
	 *
	 * @param Tx_Extbase_Persistence_ObjectStorage $related related finder
	 * @return void
	 */
	 ...
	 * Get related files
	 *
	 * @return Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_File>
	 */
	 ...
	 *
	 * @param Tx_Finder_Domain_Model_File $file
	 * @return void
	 */
	public function addRelatedFile(Tx_Finder_Domain_Model_File $file) {
	 ...
	 * Get related links
	 *
	 * @return Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_Link>
	 */
	 ...
	 * Set related links
	 *
	 * @param Tx_Extbase_Persistence_ObjectStorage<Tx_Finder_Domain_Model_Link> $relatedLinks related links relation
	 * @return void
	 */
	 ...
	 *
	 * @param Tx_Finder_Domain_Model_Media $media
	 * @return void
	 */
	public function addMedia(Tx_Finder_Domain_Model_Media $media) {
	 ...
	 * Adds a related link.
	 *
	 * @param Tx_Finder_Domain_Model_Link $relatedLink
	 * @return void
	 */
	public function addRelatedLink(Tx_Finder_Domain_Model_Link $relatedLink) {
	 ...
	 *
	 * @return Tx_Finder_Domain_Model_Media
	 */
	 ...
	 * @return integer
	 */
	public function getIstopfinder() {
		return $this->istopfinder;
	}

	/**
	 * Set top finder flag
	 *
	 * @param integer $istopfinder top finder flag
	 * @return void
	 */
	public function setIstopfinder($istopfinder) {
		$this->istopfinder = $istopfinder;
	}
	 ...
	 *
	 * @param Tx_Finder_Domain_Model_External_TtContent $contentElement
	 * @return void
	*/
	public function addContentElement(Tx_Finder_Domain_Model_External_TtContent $contentElement) {
