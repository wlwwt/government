 ...
 */
class Tx_Finder_Domain_Model_Dto_EmConfiguration {
	 ...
	 * @var string
	 */
	protected $pageModuleFieldsFinder = '';
	 ...
	 * @return string
	 */
	public function getPageModuleFieldsFinder() {
		return $this->pageModuleFieldsFinder;
	}
