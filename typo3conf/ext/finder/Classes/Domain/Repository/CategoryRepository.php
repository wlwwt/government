 ...
 */
class Tx_Finder_Domain_Repository_CategoryRepository extends Tx_Finder_Domain_Repository_AbstractDemandedRepository {

	protected function createConstraintsFromDemand(Tx_Extbase_Persistence_QueryInterface $query,
		Tx_Finder_Domain_Model_DemandInterface $demand) {}
	...
	public function findTree(array $rootIdList) {
		$subCategories = Tx_Finder_Service_CategoryService::getChildrenCategories(implode(',',$rootIdList));
