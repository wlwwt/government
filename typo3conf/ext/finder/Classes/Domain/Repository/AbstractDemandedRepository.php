 ...
 */
abstract class Tx_Finder_Domain_Repository_AbstractDemandedRepository
	extends Tx_Extbase_Persistence_Repository
	implements Tx_Finder_Domain_Repository_DemandedRepositoryInterface {
	 ...
	 * @abstract
	 */
	abstract protected function createConstraintsFromDemand(Tx_Extbase_Persistence_QueryInterface $query, Tx_Finder_Domain_Model_DemandInterface $demand);
	 ...
	 * @abstract
	 */
	abstract protected function createOrderingsFromDemand(Tx_Finder_Domain_Model_DemandInterface $demand);
	 ...
	 */
	public function findDemanded(Tx_Finder_Domain_Model_DemandInterface $demand, $respectEnableFields = TRUE) {
	 ...
	 * @return string
	 */
	public function findDemandedRaw(Tx_Finder_Domain_Model_DemandInterface $demand, $respectEnableFields = TRUE) {
		$query = $this->generateQuery($demand, $respectEnableFields);
	...
	protected function generateQuery(Tx_Finder_Domain_Model_DemandInterface $demand, $respectEnableFields = TRUE) {
		...
		if (is_array($GLOBALS['TYPO3_CONF_VARS']['EXT']['finder']['Domain/Repository/AbstractDemandedRepository.php']['findDemanded'])) {
			$params = array(
				'demand' => $demand,
			...
			foreach ($GLOBALS['TYPO3_CONF_VARS']['EXT']['finder']['Domain/Repository/AbstractDemandedRepository.php']['findDemanded'] as $reference) {
	 ...
	 * @return Tx_Extbase_Persistence_QueryResultInterface
	 */
	public function countDemanded(Tx_Finder_Domain_Model_DemandInterface $demand) {
		$query = $this->createQuery();
