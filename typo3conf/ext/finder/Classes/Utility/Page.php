...
class Tx_Finder_Utility_Page {
	 ...
	 * @return void
	 */
	public static function setRegisterProperties($properties, $object, $prefix = 'finder') {
		if (!empty($properties) && !is_null(($object))) {
			...
			foreach ($items as $item) {
				...
				try {
					...
					t3lib_div::devLog($e->getMessage(), 'finder', t3lib_div::SYSLOG_SEVERITY_WARNING);
				}
			}
