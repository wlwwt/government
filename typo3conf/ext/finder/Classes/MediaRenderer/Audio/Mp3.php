 ...
 */
class Tx_Finder_MediaRenderer_Audio_Mp3 implements Tx_Finder_MediaRenderer_MediaInterface {
	 ...
	 * @return string
	 */
	public function render(Tx_Finder_Domain_Model_Media $element, $width, $height, $template = '') {
		$url = Tx_Finder_Service_FileService::getCorrectUrl($element->getMultimedia());
		$uniqueId = Tx_Finder_Service_FileService::getUniqueId($element);
		...
		$GLOBALS['TSFE']->getPageRenderer()->addJsInlineCode('finder_audio', $inlineJs);
	 ...
	 *
	 * @param Tx_Finder_Domain_Model_Media $element media element
	 * @return boolean
	 */
