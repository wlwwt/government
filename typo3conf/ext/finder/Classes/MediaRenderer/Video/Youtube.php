 ...
 */
class Tx_Finder_MediaRenderer_Video_Youtube implements Tx_Finder_MediaRenderer_MediaInterface {
	 ...
	 * @return null|string
	 */
	public function getYoutubeUrl(Tx_Finder_Domain_Model_Media $element) {
		$videoId = NULL;
		$youtubeUrl = NULL;
