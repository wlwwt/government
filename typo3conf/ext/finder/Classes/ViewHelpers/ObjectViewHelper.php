 ...
 * Example
 * <n:object finderItem="{finderItem}"
 * 		as="out"
 ...
 * which extends the table tx_finder_domain_model_finder
 *
 ...
 */
class Tx_Finder_ViewHelpers_ObjectViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {

	/**
	 * Output different objects
	 *
	 * @param Tx_Finder_Domain_Model_Finder $finderItem current finderitem
	 ...
	 */
	public function render(Tx_Finder_Domain_Model_Finder $finderItem, $as, $className, $extendedTable = 'tx_finder_domain_model_finder') {
		$rawRecord = $GLOBALS['TYPO3_DB']->exec_SELECTgetSingleRow('*', $extendedTable, 'uid=' . (int)$finderItem->getUid());
