 ...
 * Example
 * ----------
 * <n:paginateBodytext object="{finderItem}"
 ...
 * 									<f:then>
 * 										<f:link.action action="detail" arguments="{finder: finderItem}">
 * 											{page.number}
 * 										</f:link.action>
 * 									</f:then>
 * 									<f:else>
 * 										<f:link.action action="detail" arguments="{finder: finderItem, currentPage: page.number}">
 * 											{page.number}
 * 										</f:link.action>
 * 									</f:else>
 * 								</f:if>
 ...
 */
class Tx_Finder_ViewHelpers_PaginateBodytextViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {

	/**
	 * Render everything
	 *
	 * @param Tx_Finder_Domain_Model_Finder $object current finder object
	 ...
	 * @return string
	 */
	public function render(Tx_Finder_Domain_Model_Finder $object, $as, $currentPage, $token = '###more###') {
