 ...
 */
class Tx_Finder_ViewHelpers_Format_HtmlentitiesDecodeViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	...
	public function render($value = NULL, $keepQuotes = FALSE) {
		if (class_exists('Tx_Fluid_ViewHelpers_Format_HtmlentitiesDecodeViewHelper')) {
			$message = 'EXT:finder: Since TYPO3 4.6.0, a native ViewHelper for html_entity_decode() ' .
