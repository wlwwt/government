 ...
 */
class Tx_Finder_ViewHelpers_Format_FileDownloadViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	...
	public function render($file, $configuration = array(), $hideError = FALSE) {
		if (!is_file($file)) {
			...
			t3lib_div::devLog($errorMessage, 'finder', t3lib_div::SYSLOG_SEVERITY_WARNING);
