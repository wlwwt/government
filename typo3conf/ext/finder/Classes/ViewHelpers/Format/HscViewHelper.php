 ...
 */
class Tx_Finder_ViewHelpers_Format_HscViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	...
	public function render() {
		if (class_exists('Tx_Fluid_ViewHelpers_Format_HtmlspecialcharsViewHelper')) {
			$message = 'EXT:finder: Since TYPO3 4.6.0, a native ViewHelper for htmlspecialchars() ' .
