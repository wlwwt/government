 ...
 */
class Tx_Finder_ViewHelpers_Social_Facebook_LikeViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
	...
	public function render() {
		...
		$this->tag->addAttribute('href', Tx_Finder_Utility_Url::prependDomain($url));
