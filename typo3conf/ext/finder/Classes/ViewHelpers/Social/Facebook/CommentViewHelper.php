 ...
 * Examples
 * ==============
 * <social.facebook.comment appId="165193833530000" xid="finder-{finderItem.uid}" />
 * Result: Facebook widget to comment an article
 *
 * @package TYPO3
 * @subpackage tx_finder
 */
class Tx_Finder_ViewHelpers_Social_Facebook_CommentViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
