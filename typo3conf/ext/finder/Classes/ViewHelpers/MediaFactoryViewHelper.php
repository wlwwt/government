 ...
 */
class Tx_Finder_ViewHelpers_MediaFactoryViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	 ...
	 * @param Tx_Finder_Domain_Model_Media $element Current media object
	 * @param integer $width width
	 * @param integer $height height
	 * @return string
	 */
	public function render($classes, Tx_Finder_Domain_Model_Media $element, $width, $height) {
		$content = '';
		...
		foreach ($classList as $classData) {
			...
			if (!($videoObject instanceof Tx_Finder_MediaRenderer_MediaInterface)) {
				throw new UnexpectedValueException('$videoObject must implement interface Tx_Finder_MediaRenderer_MediaInterface', 1295088673);
			}
