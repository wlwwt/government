...
Every configuration starts with tx\_finder.
 ...
 - :Property:
   ...
   :Description:
         Define preselects in the Administration module. An example would be ::
            ...
            tx_finder.module {
                    preselect {
                            topFinderRestriction = 1
                    }
            }

         which will preselect “Top finder” in the module instead of all
 ...
 - :Property:
   ...
   :Description:
         ...
         an example::
            ...
            tx_finder.predefine.archive = next friday
...
Having something like ::
   ...
   page.tx_finder.module {
           preselect {
                   topFinderRestriction = 2
           }
   }
