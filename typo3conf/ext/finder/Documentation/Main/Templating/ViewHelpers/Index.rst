...
declaration at the beginning of the template. The namespace declaration for the finder extension is: ::

	{namespace n=Tx_Finder_ViewHelpers}


Now you can use a ViewHelper of finder with a code like ::
...
Having e.g. **Tx_Finder_ViewHelpers** and **headerData** you will find the class at **finder\\Classes\ViewHelpers\\HeaderDataViewHelper.php**.
...
.. toctree::
   ...
   ExcludeDisplayedFinderViewHelper
