...
How to add a simple finder system to your site
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This walkthrough will help you to implement the extension finder at your
TYPO3 installation.
...
#. Get the extension
   ...
   #. **Get it from the Extension Manager:** Press the “Retrieve/Update”
      button and search for the extension key  *finder* and import the
      extension from the repository.

   #. **Get it from typo3.org:** You can always get current version from
      `http://typo3.org/extensions/repository/view/finder/current/
      <http://typo3.org/extensions/repository/view/finder/current/>`_ by
...
You can get the latest version from git by using the git command::
   ...
   git clone git://git.typo3.org/TYPO3v4/Extensions/finder.git
...
necessary to include the static TypoScript of finder. This is very easy:

#. Switch to the template module and to the your template record.

#. Add the finder extension to the “Include Static” list as shown in the
   screenshot
...
Before any finder record can be shown in the frontend those need to be
created.
...
#. Use the icon in the topbar “Create new record” and search for “Finder
   system” and its records. You should see “Finder”, “Finder category” and
   “Finder Tag”.

   #. Click on “Finder category” to create a new category. Insert as many
      categories as you want and use the field “Parent Category” to build up
      a category tree.

   #. Click on “Finder” to create a new finder record. Fill as many fields you
...
#. Create a new page “Detail” which will be used to show the full finder
   record. Insert the plugin “Finder system”. The 2 :sup:`nd` tab “Plugin”
   is used to configure the extension.

#. Add a new content element and select the entry “Finder system”
...
#. Create a new page “List” (or however you want to name it) and insert
   the plugin “Finder system” there again.
   ...
   #. Switch to the 2 :sup:`nd` tab “Additional” and fill the field “PageId
      for single finder display” with the page you just created before.
...
Load the List page in the frontend and you should see the finder records
as output. A click on the title should show the finder record on the
detail page.
...
.. t3-field-list-table::
 ...
 - :Property:
         Finder fields shown in page module

   :Description:
         The page module can list finder records at the bottom of the screen.

         |img-10|

         It is possible to create different list showing different fields of
         the finder record. The syntax is very simple::
 ...
 - :Property:
   ...
   :Description:
         Category records can be shown in the page module as finder records. The
 ...
 - :Property:
   ...
   :Description:
         Set the Ids of pages which are used for getting the tags. The pid can also be set in TsConfig using tx_finder.tagPid = 123
 ...
 - :Property:
   ...
   :Description:
         ...
         edited through the finder record.
 ...
 - :Property:
         Show tt\_finder importer

   :Description:
         If set, the backend module to import tt\_finder records is shown in the
         module menu. Furthermore tt\_finder needs to be installed!
 ...
 - :Property:
   ...
   :Description:
         If set and a finder record is copied in the list module, the title gets
 ...
 - :Property:
   ...
   :Description:
         If set, content elements can be added to finder records.By using content
         elements an editor got more options to include content.


 - :Property:
         Enable manual sorting of finder records

   :Description:
         If set, finder records can be sorted manually in the list module.
 ...
 - :Property:
   ...
   :Description:
         ...
         if you want to make usage of minutes and hours for finder items.
