...
The sorting can be extended by adding the value to ::
   ...
   $GLOBALS['TYPO3_CONF_VARS']['EXT']['finder']['orderByFinder']
...
If you need an additional action to select, you can extend it by using: ::
	...
	$GLOBALS['TYPO3_CONF_VARS']['EXT']['finder']['switchableControllerActions']['newItems']['Finder->byFobar'] = 'A fobar action';
...
take a look at the hook inside the class Hooks/T3libBefunc.php: ::
	...
	$GLOBALS['TYPO3_CONF_VARS']['EXT']['finder']['Hooks/T3libBefunc.php']['updateFlexforms']
...
your own selections by adding those to ::
   ...
   $GLOBALS['TYPO3_CONF_VARS']['EXT']['finder']['templateLayouts']['myext'] = array('My Title', 'my value');
