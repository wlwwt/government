...
version of finder. If you found a bug, please check the page
`http://forge.typo3.org/projects/extension-finder/issues
<http://forge.typo3.org/projects/extension-finder/issues>`_ if the bug
has already been reported (and maybe even already been fixed) and if
...
Have a look at the git logs at http://git.typo3.org/TYPO3v4/Extensions/finder.git?a=shortlog to get a proof.
...
Take a look at http://montagmorgen.at/donate.html