...
Categories are not required but can be used to structure finder records
in the frontend (e.g. show only finder records which belong to category
A and B).
...
.. t3-field-list-table::
 ...
 - :Field:
         Single-view page for finder from this category

   :Description:
         If a page is defined, it is used as page for displaying the finder
         record. If a finder record belongs to more than one category, only the 1
         :sup:`st` category is checked for this field.


 - :Field:
         Finder category shortcut

   :Description:
         Optional link of a finder category


Finder
""""

The following table describes the main fields of a finder record.
...
.. t3-field-list-table::
 ...
 - :Field:
   ...
   :Description:
         Header of a finder record. It is a required field.
 ...
 - :Field:
   ...
   :Description:
         Finder records can be marked as top finder if it is an important one.
 ...
 - :Field:
   ...
   :Description:
         A finder record can belong to one of the following types:

         - “Finder”: Default finder record

         - “Internal Page”: The finder record is linked to a regular page

         - “External Page”: The finder record is linked to an external page
 ...
 - :Field:
   ...
   :Description:
         ...
         of the finder record in some sentences. Depending on the configuration
 ...
 - :Field:
   ...
   :Description:
         Main content of the finder record. This field is only shown with the
         type “Finder”.
 ...
 - :Field:
   ...
   :Description:
         Add normal content elements to a finder records. This field can be
 ...
 - :Field:
   ...
   :Description:
         Selection of categories the finder record belongs to.
 ...
 - :Field:
   ...
   :Description:
         Define finder records which are related to the current one.
 ...
 - :Field:
   ...
   :Description:
         Set keywords of this finder record, separated with a comma (',')
 ...
 - :Field:
   ...
   :Description:
         Media elements belonging to this finder record. Those are described
         below.
...
can be inserted in a finder record.
